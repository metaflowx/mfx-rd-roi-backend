...
// // Example usage
// const userId = '12345'; // Use the same userId for encryption and decryption
// const data = 'hi bhai';

// const encrypted = hybridEncrypt(accessTokenPublicKey, data, userId);
...
// const userId1 = '1234'; // Use the same userId for encryption and decryption
// const data1 = 'hi bhai 2';
// const userId2 = '123'; // Use the same userId for encryption and decryption
// const data2 = 'hi bhai 3';
// const encrypted1 = hybridEncrypt(accessTokenPublicKey,data1, userId1);
// console.log('Encrypted:', encrypted1);

// const decrypted1 = hybridDecrypt(
//     accessTokenPrivateKey,
//     encrypted1.encryptedData,
//     encrypted1.encryptedSymmetricKey,
//     userId1,
//     encrypted1.salt
// );
// console.log('Decrypted:', decrypted1);

// const encrypted2 = hybridEncrypt(accessTokenPublicKey, data2,userId2);
// console.log('Encrypted:', encrypted2);

// const decrypted2 = hybridDecrypt(
//     accessTokenPrivateKey,
